...
# the sentence.
# The interpreter module communicates with the lexet module to retrieve the
# next token from the sentenceself.
...
class Interpreter:
    ...
    # This method defines an expression which is a non terminatin tokenself.
    # Grammar.
    # expr = fact ((MUL/DIV)fact)*
    # fact = Integer.
    def expr(self):
        result = self.factor()
